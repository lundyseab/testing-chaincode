...
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	assets := []Asset{
	  {ID: "AssetsUpdate1", Color: "red", Size: 5, Owner: "Lundy", AppraisedValue: 300},
	}
...
func (s *SmartContract) GetAllAssetsUpdate(ctx contractapi.TransactionContextInterface) ([]*Asset, error) {
...
func (s *SmartContract) test(ctx contractapi.TransactionContextInterface) ([]*Asset, error) {
	// range query with empty string for startKey and endKey does an
	// open-ended query of all assets in the chaincode namespace.
	resultsIterator, err := ctx.GetStub().GetStateByRange("", "")
	if err != nil {
